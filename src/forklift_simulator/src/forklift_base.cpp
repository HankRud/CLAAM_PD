#include "forklift_base.h"

ForkliftBase::ForkliftBase():
    ...
    heading_(0)
{
    ...
    velocity_subscriber_ = nh_.subscribe("cmd/vel", 50, &ForkliftBase::velCallback, this);
}

void ForkliftBase:: velCallback(const geometry_msgs::Twist &vel)
{
